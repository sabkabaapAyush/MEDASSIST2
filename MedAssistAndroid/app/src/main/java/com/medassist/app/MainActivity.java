...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // In production, this would point to your actual server URL
        // For testing, use a local IP or a deployed version
        webView.loadUrl("http://localhost:5000"); // Use actual server URL in production
    }
